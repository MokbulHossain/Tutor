            ...
            <div class="card-body">
              ...
              <div class="row">
              	...
              	<div class="col-md-4">
              		...
              		<p>DOB : {{$profile->DOB}}</p>
              		<p>School Address : {{$profile->school_location}}</p>
              		<p>Parent Name : {{$profile->parent_name}}</p>
              		<p>Parent Email : {{$profile->parent_email}}</p>
              	</div>
              	<div class="col-md-2">
                 ...
                 <div id="edit_content" style="display: none">
                 	<form id="edit_info" method="post" action="{{route('edit_student_profile')}}" enctype="multipart/form-data">
                 		@csrf
              	...
              	<div class="col-md-6 offset-md-4">
                   ...
                   <div class="col-md-6">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-10 col-sm-10 col-xs-12" for="first-name"> School Name <span class="required">*</span>
                        </label>
                        <div class="col-md-10 col-sm-10 col-xs-12">
                          <input type="text" class="form-control" name="school_name" value="{{$profile->school_name}}" required="true" placeholder="Enter School Name">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-10 col-sm-10 col-xs-12" for="first-name"> School Location
                        </label>
                        <div class="col-md-10 col-sm-10 col-xs-12">
                          <input type="text" class="form-control" name="school_location" value="{{$profile->school_location}}" placeholder="Enter School location">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-10 col-sm-10 col-xs-12" for="first-name"> Parent Name <span class="required">*</span>
                        </label>
                        <div class="col-md-10 col-sm-10 col-xs-12">
                          <input type="text" class="form-control" name="parent_name" value="{{$profile->parent_name}}" required="true" placeholder="Enter Parent Name">
                        </div>
                      </div>
              	...
              	<div class="col-md-6">
                       ...
                       <div class="form-group">
                        <label class="control-label col-md-10 col-sm-10 col-xs-12" for="first-name"> DOB <span class="required">*</span>
                        </label>
                        <div class="col-md-10 col-sm-10 col-xs-12">
                          <input type="date" class="form-control" name="DOB" value="{{$profile->DOB}}" required="true" placeholder="">
                        </div>
                      </div>
                      
                      <div class="form-group">
                        <label class="control-label col-md-10 col-sm-10 col-xs-12" for="first-name"> Parent Email <span class="required">*</span>
                        </label>
                        <div class="col-md-10 col-sm-10 col-xs-12">
                          <input type="text" class="form-control" name="parent_email" value="{{$profile->parent_email}}" required="true" placeholder="Enter Parent Email">
                        </div>
                      </div>
