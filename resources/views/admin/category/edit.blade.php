            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Category</h3>
                          <a class="col-lg-offset-5 btn btn-success" href="{{route('category.index')}}">Add New</a>
             ...
             @include('includes.messages')
              ...
              <form role="form" action="{{ route('category.update',$category->id)}}" method="post">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="slug">Ctaegory Slug</label>
                    <input type="text" class="form-control" id="slug" placeholder="Post slug" name="slug" value="{{ $category->slug }}">
                  </div>
